"""
Django settings for vtest5492ra_1 project.
...
ROOT_URLCONF = 'vtest5492ra_1.urls'
...
WSGI_APPLICATION = 'vtest5492ra_1.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "vtest5492RA Support <support@vtest5492ra-1.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "vtest5492ra_1 API",
    "DESCRIPTION": "API documentation for vtest5492ra_1 App",
    "VERSION": "v1",
}
...
if AS_BUCKET_NAME:
    ...
    DEFAULT_FILE_STORAGE = "vtest5492ra_1.storage_backends.AzureMediaStorage"
    STATICFILES_STORAGE = "vtest5492ra_1.storage_backends.AzureStaticStorage"
